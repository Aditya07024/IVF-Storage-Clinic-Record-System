                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        {(() => {
                          ...
                          if (activeBatches > 0) {
                            return (
                              <span className="px-2.5 py-1 bg-emerald-100 text-emerald-950 rounded-lg text-xs font-bold font-mono border border-emerald-300">
                                {activeBatches} Active Batch(es)
                              </span>
                            );
                          }
                          return (
                            <span className="px-2.5 py-1 bg-slate-100 text-slate-600 rounded-lg text-xs font-bold font-mono border border-slate-300">
                              0 Active (All Thawed)
                            </span>
                          );
                        })()}
